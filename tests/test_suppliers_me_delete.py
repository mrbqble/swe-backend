"""Tests for DELETE /api/v1/suppliers/me endpoint."""
...
class TestDeleteMySupplier:
    """Test cases for DELETE /api/v1/suppliers/me."""

    def test_delete_my_supplier_success(
        self,
        ...
        """Test successful deletion of supplier account."""
        ...
        data = response.json()
        assert data["message"] == "Supplier account deleted successfully"

    def test_delete_my_supplier_not_found(
        self,
        test_client: TestClient,
        mock_db_session: AsyncMock,
        override_get_db: Any,
        ...
        """Test delete supplier when profile not found."""
        # Create a valid access token
        access_token = create_access_token(
            data={
                "sub": sample_supplier_owner.id,
    ...
    def test_delete_my_supplier_not_supplier_owner(
        self,
        test_client: TestClient,
        mock_db_session: AsyncMock,
        override_get_db: Any,
        ...
        """Test delete supplier with non-supplier-owner role."""
    ...
    def test_delete_my_supplier_no_token(
        self,
        test_client: TestClient,
        mock_db_session: AsyncMock,
        override_get_db: Any,
    ) -> None:
        """Test delete supplier without authentication token."""
        # Test request without token
        response = test_client.delete("/api/v1/suppliers/me")
